                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="alert alert-dark rounded" role="alert">
                                <br>
                                <p class="lead" style="text-align: center;vertical-align: center;padding-bottom: 4px">¡Gracias!<br>Su información ha sido enviada, muy pronto nos pondremos en contacto con usted.</p>
                            </div>
                        </div>
