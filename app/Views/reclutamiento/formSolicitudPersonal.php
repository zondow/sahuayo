        ...
        <div class="card-box">
            <form action="<?= base_url('Reclutamiento/addSolicitudPersonal') ?>" method="post" autocomplete="off" role="form">
                <div class="card-box widget-flat border-blue bg-success text-white" style="background-color: #001689!important;border-radius: 15px">
                    ...
                    <h4 class="text-uppercase font-weight-bold text-white">Generales</h4>
                </div>
                <div class="col-12">
                    <div class="row">
                        <div class="col-4">
                ...
                <div class="card-box widget-flat border-blue bg-success text-white" style="background-color: #001689!important;border-radius: 15px">
                    <i class="fas fa-user-friends " style="right: 5%;left:auto;"></i>
                    <h4 class="text-uppercase font-weight-bold text-white">Datos Del Solicitante</h4>
                </div>
                <div class="col-12">
                    <div class="row">
                        <div class="col-6">
                ...
                <hr style="width:100%;text-align:left;margin-left:0">
                <div class="card-box widget-flat border-blue bg-success text-white" style="background-color: #001689!important;border-radius: 15px">
                    <i class="mdi mdi-desktop-mac-dashboard" style="right: 5%;left:auto;"></i>
                    <h4 class="text-uppercase font-weight-bold text-white">Datos Del Puesto Vacante</h4>
                </div>
                <div class="col-12">
                    <div class="row">
                        <div class="col-12">
                ...
                <div class="col-12">
                    <div class="row">
                        <div class="col-7">
                            ...
                            <select class="form-control select2" name="nombrePuesto" id="nombrePuesto" required>
                                <option hidden>Seleccione</option>
                        ...
                        <div class="col-6">
                            <label class="control-label"> * Departamento:</label>
                            <select class="form-control select2" name="departamentoVac" id="departamentoVac" required>
                                <option hidden>Seleccione</option>
                        ...
                        <div class="col-5" id="divNuevoDepartamento">
                        ...
                        <div class="col-4">
                            ...
                            <select class="form-control select2" name="areaVac" id="areaVac" required>
                                <option hidden>Seleccione</option>
                        ...
                        <div class="col-12">
                            ...
                            <select id="personalCargo" name="personalCargo" class="form-control">
                                <option hidden>Seleccione</option>
                        ...
                        <div class="col-12" id="divPuestoC">
                            ...
                            <select class="form-control select2-multiple" multiple="multiple" name="puestosCoordina[]" id="puestosCoordina">
                                <?php foreach ($puestos as  $puesto) { ?>
                ...
                <hr style="width:100%;text-align:left;margin-left:0">
                <div class="card-box widget-flat border-blue bg-success text-white" style="background-color: #001689!important;border-radius: 15px">
                    <i class="fe-file-text " style="right: 5%;left:auto;"></i>
                    <h4 class="text-uppercase font-weight-bold text-white">Requisitos del puesto</h4>
                </div>
                <div class="col-12">
                    <div class="row">
                        <div class="col-4">
                            <label class="control-label"> * Escolaridad:</label>
                            <select class="form-control select2" name="escolaridad" id="escolaridad" required>
                                <option hidden>Seleccione</option>
                ...
                <div class="col-12">
                    <div class="row">
                        ...
                        <div class="col-4">
                            ...
                            <select id="ecivil" name="ecivil" class="form-control" required>
                                <option hidden>Seleccione</option>
                ...
                <hr style="width:100%;text-align:left;margin-left:0">
                <div class="card-box widget-flat border-blue bg-success text-white" style="background-color: #001689!important;border-radius: 15px">
                    <i class="fas fa-file-signature  " style="right: 5%;left:auto;"></i>
                    <h4 class="text-uppercase font-weight-bold text-white">Especificación de la contratación</h4>
                </div>
                <div class="col-12">
                    <div class="row">
                        <div class="col-4">
                            <label class="control-label"> * Contrato por tiempo:</label>
                            <select id="contratoTiempo" name="contratoTiempo" class="form-control" required>
                                <option hidden>Seleccione</option>
