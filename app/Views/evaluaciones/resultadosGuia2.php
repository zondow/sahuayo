...
<div class="row" <?= $style ?>>
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <div class="header">
                    <h2><strong>Total Calificación</strong></h2>
                </div>
            ...
            <div class="card-body">
                <div class="file-man-box rounded mb-3">
                    ...
                    <div class="file-man-title">
                        <h5 class="mb-0 " style="overflow: hidden;color:#00acc1!important">Evaluaciones aplicadas Guia II
                        </h5>
                    </div>
                </div>
            </div>
...
<div class="row" <?= $style ?>>
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <a href="<?= base_url("PDF/interpretacionG2CentroTrabajo/" . $FechaInicio . "/" . $FechaFin) ?>" class="btn btn-warning btn-round show-pdf" style="color: white" data-title="Resultados" target="_blank"><i class="fa fa-print"></i> Imprimir resultados</a>
                <div class="col-12">
                    <div id="container">
