...
<div class="content card-box">
    ...
    ?>
                ...
                <form action="<?= base_url('Evaluaciones/saveEvaluacionCompetenciaJefe') ?>" method="post" autocomplete="off">
                    <input type="hidden" name="empleadoID" value="<?= $empleadoID ?>">
                    <input type="hidden" name="idPeriodo" value="<?= $fechaEstatus ?>">
                    <input type="hidden" name="jefeID" value="<?= encryptDecrypt('encrypt', $jefeID) ?>">
