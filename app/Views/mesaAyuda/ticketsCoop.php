    ...
    <div class="col-lg-12">
        <div class="card-box ">
            <div class="table-responsive">
                <table class="table table-hover m-0 table-centered tickets-list table-actions-bar dt-responsive datatableTickets text-center" cellspacing="0" width="100%" id="datatableMisTickets">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        ...
                        if($tickets){
                            foreach($tickets as $ticket){
                                ...
                                //Acciones
                                $acciones = '<a href="'.base_url('MesaAyuda/ticket/'.encryptDecrypt('encrypt',$ticket['tic_TicketID'])).'" class="btn btn-info btn-block btn-sm waves-light waves-effect" title="Ver Ticket"><i class="far fa-eye"></i></a>';
