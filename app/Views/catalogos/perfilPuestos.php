                ...
                <div class="row">
                    ...
                    <div class="row col-md-12">
                        <div class="form-group col-md-12  pt-2 ">
                            ...
                            <textarea class="form-control" id="inputConocimiento" name="inputConocimiento" placeholder="Escribir los conocimientos" required><?= (isset($perfilpuesto['per_Conocimientos'])) ? $perfilpuesto['per_Conocimientos'] : '' ?></textarea>

                        </div>
                    </div>
                    <div class="row col-md-12">
                        <div class="form-group col-md-12  pt-2 text-center">
                            ...
                            ?>
                                            <div class="row" id="divF<?= $contador ?>">
                                                ...
                                                <div class="form-group col-md-1 text-center pt-3">
                                                    <button class="btn btn-danger waves-effect waves-light btnEliminar text-center" data-id="<?= $contador ?>"><i class="dripicons-trash"></i></button>
                                                </div>
                                            </div>
                            <?php }
                                    }
