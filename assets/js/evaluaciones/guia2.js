$(document).ready(function () {
    ...
    if(FechaFin && FechaInicio && SucursalID){
        var tbl = $("#datatable").DataTable({
            ...
            ajax: {
                url: BASE_URL + "Evaluaciones/ajax_getEvaluados/"+FechaInicio+"/"+FechaFin+"/"+SucursalID,
                dataType: "json",
                type: "POST",
                "processing": true,
            },
        ...
        $.ajax({
            url: BASE_URL + 'Evaluaciones/ajax_getDominios/'+FechaInicio+"/"+FechaFin+"/"+SucursalID,
            cache: false,
            type: 'post',
            dataType: 'json',
        }).done(function (data) {
        ...
        function guardarImagenes() {
            ...
            //Ajax guardar imagen
            $.ajax({
                url: BASE_URL+'Evaluaciones/ajaxGuardarInterpG2/',
                type: 'post',
                cache: false,
                async: false,
                data: {
    ...
    $('#btn').click(function(e){
        ...
        window.open(BASE_URL + "Evaluaciones/resultadosGuiaII/" + fInicio+"/"+fFin+"/"+sucursal, "_self");
    });
