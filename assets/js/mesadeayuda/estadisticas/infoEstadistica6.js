$(document).ready(function () {
    ...
    $btnConsultar.click(function (e) {
		...
		if($fechaInicio.val() !== "" && $fechaFin.val() !== "" ){
            window.open(BASE_URL + "MesaAyuda/infoEstadistica/6/" +$fechaInicio.val()+"/"+$fechaFin.val(), "_self");
		}else{
			$.toast({
    ...
    var tblTickets =  $("#tblTickets").DataTable({
        ...
        paging:         true,
        ajax: {
            url: BASE_URL + "MesaAyuda/ajax_TicketsGCoopPeriodoTabla/"+$("#fechaInicio").val()+'/'+$("#fechaFin").val(),
            dataSrc: '',
        },
        columns: [
            { "data": "numero"},
    ...
    RespChart.prototype.init = function () {
        var self = this;
        $.ajax({
            url: BASE_URL + "MesaAyuda/ajax_TicketsGCoopPeriodo/"+$("#fechaInicio").val()+'/'+$("#fechaFin").val(),
            method: "GET",
            dataType: "json",
