...
export interface TemplateProcessor {
     ...
     */
    handleAttributeExpressions(element: Element, name: string, strings: readonly string[], options: RenderOptions, templatePart?: AttributeTemplatePart): readonly Part[];
    /**
     * Create parts for a text-position binding.
     * @param partOptions
     */
    handleTextExpression(options: RenderOptions, templatePart?: NodeTemplatePart): NodePart;
}
